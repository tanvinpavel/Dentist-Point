              ...
              <div className="container text-center text-md-start pt-5">
                ...
                <div className="row">
                  ...
                  <div className="col-md-3 col-lg-4 text-white col-xl-3 mx-auto mb-4">
                    ...
                    <h6 className="text-uppercase fw-bold"><img style={{height:50}} src="" alt="" /> Attentive Hospital</h6>
                    ...
                    <p>Attentive Hospital mission is to providing excellent care for patient lays out the vision for the hospital that includes medical services structured around the needs of patients.</p>
